...
- **Informační architektura, struktura úložišť, naming conventions** - role pro informační architekturu.
- **Grafický designový systém bez kódové implementace** - role pro vizuální designový systém.
